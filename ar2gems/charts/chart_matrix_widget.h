...
#ifndef CHART_MATRIX_WIDGET_H
#define CHART_MATRIX_WIDGET_H
...
class CHARTS_DECL Chart_matrix_widget : public QVTKWidget
{
  Q_OBJECT

public:
    Chart_matrix_widget(QWidget *parent=0);
    virtual ~Chart_matrix_widget();

    vtkChartMatrix* chart_matrix() {return chart_matrix_.GetPointer();}
...
protected:
  ...
  Chart_display_control* chart_control_;
	...
	vtkSmartPointer<vtkChartMatrix> chart_matrix_;
