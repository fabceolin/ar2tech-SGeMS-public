 ...
 *  RGrid
 **************************************************/
BOOST_AUTO_TEST_CASE(RGrid_random_path___begin___end___size)
{
  std::string grid_name("grid, RGrid_random_path___begin___end___size");
  ...
  std::string prop_name("prop, RGrid_random_path___begin___end___size");
  Grid_continuous_property * prop = grid->add_property(prop_name);
  BOOST_REQUIRE(prop);
  grid->select_property(prop_name);
  
  // create grid_random_path
  Grid_random_path * path = new Grid_random_path(grid, prop);
  BOOST_REQUIRE(path);
...
BOOST_AUTO_TEST_CASE(RGrid_random_path___node_id___geovalue)
{
  std::string grid_name("grid, RGrid_random_path___node_id___geovalue");
  Cartesian_grid* grid = cartesian_grid(grid_name);
  BOOST_REQUIRE(grid);
  const int grid_size = 3*3*3;
  grid->set_dimensions(3, 3, 3);
  ...
  // add property to grid
  std::string prop_name("prop, RGrid_random_path___node_id___geovalue");
  Grid_continuous_property * prop = grid->add_property(prop_name);
  BOOST_REQUIRE(prop);
  grid->select_property(prop_name);
...
BOOST_AUTO_TEST_CASE(RGrid_random_path___4threads)
{
  std::string grid_name("grid, RGrid_random_path___4threads");
  Cartesian_grid* grid = cartesian_grid(grid_name);
  BOOST_REQUIRE(grid);
  const int grid_size = 3*3*3;
  grid->set_dimensions(3, 3, 3);
  ...
  // add property to grid
  std::string prop_name("prop, RGrid_random_path___4threads");
  Grid_continuous_property * prop = grid->add_property(prop_name);
  BOOST_REQUIRE(prop);
  grid->select_property(prop_name);
  ...
  Grid_path_task<Grid_random_path::iterator>::Ptr tasks[num_tasks];
  for (int i = 0; i < num_tasks; i++) {
    tasks[i] = Grid_path_task<Grid_random_path::iterator>::Ptr_new();
  ...
  std::vector<Grid_random_path::iterator> nodes[num_tasks];
 ...
 *  Point-set
 **************************************************/
BOOST_AUTO_TEST_CASE(Point_set_random_path___begin___end___size)
{
  std::string pset_name("pset, Point_set_random_path___begin___end___size");
  ...
  // add property to grid
  std::string prop_name("prop, Point_set_random_path___begin___end___size");
  Grid_continuous_property * prop = pset->add_property(prop_name);
  BOOST_REQUIRE(prop);
  pset->select_property(prop_name);
  
  // create grid_random_path
  Grid_random_path * path = new Grid_random_path(pset, prop);
  BOOST_REQUIRE(path);
...
BOOST_AUTO_TEST_CASE(Point_set_random_path___node_id___geovalue)
{
  std::string pset_name("pset, Point_set_random_path___node_id___geovalue");
  Point_set * pset = point_set(pset_name, 3*3*3);
  BOOST_REQUIRE(pset);
  std::vector< Point_set::location_type > point_locations;
  for (int x = 0; x < 3; x++)
  ...
  // add property to grid
  std::string prop_name("prop, Point_set_random_path___node_id___geovalue");
  Grid_continuous_property * prop = pset->add_property(prop_name);
  BOOST_REQUIRE(prop);
  pset->select_property(prop_name);
...
BOOST_AUTO_TEST_CASE(Point_set_random_path___4threads)
{
  std::string pset_name("pset, Point_set_random_path___4threads");
  Point_set * pset = point_set(pset_name, 3*3*3);
  BOOST_REQUIRE(pset);
  std::vector< Point_set::location_type > point_locations;
  for (int x = 0; x < 3; x++)
  ...
  // add property to grid
  std::string prop_name("prop, Point_set_random_path___4threads");
  Grid_continuous_property * prop = pset->add_property(prop_name);
  BOOST_REQUIRE(prop);
  pset->select_property(prop_name);
