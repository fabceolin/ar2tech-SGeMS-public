...
class QTPLUGINS_DECL Region_proxy_model : public QAbstractProxyModel{

	Q_OBJECT
public:
	Region_proxy_model(Geostat_grid* grid,QObject *parent = 0);
	virtual ~Region_proxy_model();
...
protected :
	...
	Grid_region_manager* root_;
	Geostat_grid* grid_;

};


class QTPLUGINS_DECL Region_proxy_model_no_selection : public Region_proxy_model{

	Q_OBJECT
public:
	Region_proxy_model_no_selection(Geostat_grid* grid,QObject *parent = 0);
	virtual ~Region_proxy_model_no_selection();
