		    ...
		    Error_messages_handler* error_mesgs )
{
    ...
    {
        error_mesgs->report( "GridSelector_Sim", "No grid specified" );
        return false;
    }
        ...
        */
        ...
        else    // partition with k-mean
        {
            ...
            if ( nreal == 1 && first_run ) {
              PrototypeListType2 proto;
              create_prototypelist( proto, nreal, ncoarse, nb_facies_, TI_neighbors, patch_neighbors, 
                                                                                cur_score, cmin_replicates_[ncoarse-1]);
              proto_list_kmeans_.push_back(proto);
            ...
            if ( ncoarse>start_score_based_dist )   // use pixel-based distance calculation
            {
                ...
                if ( use_soft_field_ )
                {
                    ...
                    status = sequential_patch_simulation_categorical_2(
                                                            path_begin, 
                                                            path_end,
                                                            proto_list_kmeans_[nb_multigrids_-ncoarse],     
                                                            *categorical_sampler, 
                                                            updater,
                                                            hd_dev_finder,  
                                                            st_dev_finder,
