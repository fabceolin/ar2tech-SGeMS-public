...
private:
    ...
    void get_property_vector( Grid_continuous_property* prop, vector<float>& data, bool use_region=false );
    void trans_prop_cdf( Grid_continuous_property* prop, Non_param_cdf<>& source_cdf );
