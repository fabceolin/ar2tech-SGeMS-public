...
private:
    ...
    bool get_current_cdf( Grid_continuous_property*prop );
    ...
    void post_processing_realization( Grid_continuous_property*prop );
...
private:
    ...
    vector< PrototypeListType2 > proto_list_kmeans_;
   // PrototypeListType2 proto_list_kmeans_;
    // for debug output
	int is_viewscore_;
