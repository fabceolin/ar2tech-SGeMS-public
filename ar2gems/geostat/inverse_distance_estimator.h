...
#ifndef __iNVERSE_DISTANCE_ESTIMATOR__ 
#define __iNVERSE_DISTANCE_ESTIMATOR__ 
...
class GEOSTAT_DECL Inverse_distance_estimator :
  public Geostat_algo
{
public:
  Inverse_distance_estimator(void);
  virtual ~Inverse_distance_estimator(void);

	  virtual bool initialize( const Parameters_handler* parameters,
				   Error_messages_handler* errors );
	  virtual int execute( GsTL_project* proj=0 );
	  virtual std::string name() const { return "inverse-distance"; }
