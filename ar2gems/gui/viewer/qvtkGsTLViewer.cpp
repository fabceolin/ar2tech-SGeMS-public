...
// Create the axes marker
  ...
  scale_actor_->GetRightAxis()->SetLabelFormat("%.2f" );
  scale_actor_->GetLeftAxis()->SetLabelFormat("%.2f");
  scale_actor_->GetTopAxis()->SetLabelFormat("%.2f" );
  scale_actor_->GetBottomAxis()->SetLabelFormat("%.2f");
